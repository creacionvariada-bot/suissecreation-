...
def validate():
    # Corrections per user request:
    fb_title_a = "Quatre-vingt-quinze pour cent de projets IA sans aucun retour sur investissement."
    # 7. TÍTULO FACEBOOK B: clarify it's a single 100M lawsuit
    fb_title_b = "Une plainte de cent millions de dollars : l'IA détruit la stratégie des élites."
    ...
    # 2. INSTAGRAM CAPTION: Keep "correction brutale", 150-200 chars. Reduce length from previous attempt.
    ig_cap_b1 = "Dix-neuf mille milliards de valorisation IA commencent à se dégonfler rapidement."
    ...
    with open('EP09_SILICON_MONEY_FR/SEO_COPY_FINAL.txt', 'w', encoding='utf-8') as f:
        ...
        # 1. FACEBOOK HASHTAGS: replace #AIBubbleCrash with #AICorrection
        f.write("#Patrimoine #AIBubble #TechLayoffs #DataCenters #AICorrection\n")
        ...
        f.write("ALT TEXT\n")
        # 3. ALT TEXT: correction in progress
        f.write("Un investisseur observe la correction du marché de l'intelligence artificielle.\n")
        f.write("THUMBNAIL\n")
        # 4. THUMBNAIL: BULLE / IA
        f.write("LINE 1: BULLE\n")
        f.write("LINE 2: IA\n")
        f.write("SUBTITLE KEYWORDS\n")
        # 5. SUBTITLE KEYWORDS: CORRECTION instead of KRACH
        f.write("CORRECTION — BULLE — PATRIMOINE — STRATÉGIE — LICENCIEMENTS\n")
        ...
        # 6. SHORT TITLE, LOWER THIRD 2, END CARD: La Bulle de l'IA
        f.write("SHORT TITLE: La Bulle de l'IA\n")
        f.write("LOWER THIRD 1: L'Empire de l'IA\n")
        f.write("LOWER THIRD 2: Ep. 9 — La Bulle de l'IA\n")
        f.write("OPENING CARD: L'Empire de l'IA | Épisode 9\n")
        f.write("END CARD: La Bulle de l'IA\n")
