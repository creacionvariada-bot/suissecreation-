...
import sys
with open('fix_counts_v2.py', 'r') as f:
    content = f.read()

# I will just write a new fast python script to output the final script
# instead of patching the old one to save time and token limits.
...
sentences = [
    ...
    "Au lieu de révolutionner radicalement nos économies occidentales, ces systèmes numériques coûteux échouent lamentablement à accomplir les tâches primaires, forçant les immenses conglomérats internationaux à recruter les anciens salariés.", # 2: 30 words
    "Une très célèbre franchise de restauration rapide vient récemment d'engager une poursuite astronomique de cent millions de dollars contre sa maison mère européenne après un déploiement véritablement catastrophique destructeur.", # 3: 30 words
    "Leur nouvel outil complexe de répartition automatisé a considérablement ralenti les opérations quotidiennes de livraison, détruisant instantanément la rentabilité globale et provoquant une chute vertigineuse des ventes régionales immédiates.", # 4: 30 words
    "Cette correction silencieuse mais totalement implacable traverse actuellement toutes les sphères financières mondiales, provoquant de terribles sueurs froides chez les investisseurs institutionnels qui ont parié leur immense héritage.", # 5: 29 words
    "La destruction rapide de capitaux inédits soulève désormais une question fondamentale concernant la véritable valeur intrinsèque des immenses sociétés technologiques qui dominent aujourd'hui les marchés boursiers modernes et volatils.", # 6: 30 words
    ...
    "Les investisseurs avertis commencent enfin à comprendre que cette frénésie d'accumulation technologique pourrait engendrer une sévère crise financière systémique capable de ravager totalement les portefeuilles institutionnels particulièrement solides.", # 9: 29 words
    ...
    "Cette gigantesque somme astronomique représente un danger et un risque systémique sans précédent historique depuis la fin tragique des entreprises de l'internet au tout début des années deux mille.", # 11: 30 words
    "Nous assistons aujourd'hui à l'éclatement progressif d'une vaste bulle spéculative, où l'enthousiasme aveugle des investisseurs fortunés se heurte brutalement aux innombrables limites technologiques réelles d'aujourd'hui.", # 12: 28 words -> let's count: Nous(1) assistons(2) aujourd(3) hui(4) à(5) l(6) éclatement(7) progressif(8) d(9) une(10) vaste(11) bulle(12) spéculative(13) où(14) l(15) enthousiasme(16) aveugle(17) des(18) investisseurs(19) fortunés(20) se(21) heurte(22) brutalement(23) aux(24) innombrables(25) limites(26) technologiques(27) réelles(28) d(29) aujourd(30) hui(31).
    # wait d'aujourd'hui = d aujourd hui = 3 words. So 31. Let's fix 12.
    "Nous assistons à l'éclatement progressif d'une vaste bulle spéculative, où l'enthousiasme aveugle des investisseurs fortunés se heurte brutalement aux limites technologiques du monde financier moderne.", # 12: 28 words.
    "Les colossales infrastructures informatiques nécessitent des ressources électriques qui demeurent physiquement impossibles à déployer correctement, rendant ainsi les immenses investissements initiaux totalement inutiles pour les grandes puissances mondiales.", # 13: 29 words
    "Pendant que les dirigeants technologiques vendent lâchement leurs propres actions personnelles, les investisseurs institutionnels ordinaires conservent aveuglément leurs portefeuilles, espérant naïvement une reprise économique miraculeuse absolument impossible et illusoire.", # 14: 29 words
    ...
    "Ce revirement brutal des immenses conglomérats occidentaux annonce une sévère correction drastique du marché financier mondial, affectant irrémédiablement le précieux patrimoine sécurisé des familles les plus fortunées aujourd'hui même.", # 16: 30 words
    "La dure réalité économique finit toujours par rattraper les illusions technologiques les plus séduisantes, détruisant sans aucune pitié les portefeuilles mal diversifiés des investisseurs refusant fièrement cette imminente correction.", # 17: 29 words
    "Une grande entreprise internationale spécialisée a follement dépensé environ cinq cents millions de dollars en un seul mois pour des outils numériques totalement inutiles, illustrant parfaitement cette folie financière irrationnelle.", # 18: 30 words
    "L'effondrement silencieux de ces immenses entreprises phares pourrait bientôt se propager vers d'autres secteurs critiques, entraînant une vaste panique boursière inévitable chez tous les grands investisseurs institutionnels européens.", # 19: 29 words
    "Une prestigieuse institution d'analyse financière confirme que d'immenses projets informatiques atteignant plus de deux gigawatts de puissance électrique totale ont été purement et simplement abandonnés sans aucune explication.", # 20: 29 words
    ...
    "Votre propre patrimoine personnel est-il actuellement lourdement exposé à cette bulle spéculative très dangereuse qui menace brutalement de détruire vos précieuses réserves financières ? Suivez le canal pour la révélation.", # 23: 30 words
    ...
    "Une fameuse entreprise émergente s'est effondrée brutalement après la découverte soudaine d'une vaste fraude comptable colossale s'élevant à exactement cent quatre-vingts millions d'euros cette année.", # 40: 28 words
    ...
    "Chaque faillite de ces jeunes entreprises innovantes envoie un message d'avertissement clair aux banquiers concernant l'impossibilité de monétiser rapidement ces colossales infrastructures informatiques lourdement subventionnées par les états.", # 46: 28 words
    ...
    "L'effondrement colossal de la confiance envers l'automatisation précipitera inévitablement une panique financière mondiale dévastatrice, détruisant définitivement les espoirs d'une croissance boursière infinie et miraculeuse pour tous les actionnaires.", # 50: 28 words
    ...
    "La réévaluation drastique des gigantesques budgets informatiques mondiaux provoque actuellement un vaste séisme financier silencieux mais terriblement dévastateur, qui menace de ruiner définitivement tous les investisseurs ignorant ces signaux.", # 53: 29 words
    ...
    "Cette sagesse pragmatique retrouvée contraste brutalement avec la folie des petits spéculateurs mal informés, s'accrochant désespérément à leurs illusions virtuelles malgré l'effondrement de cet immense édifice financier.", # 55: 28 words
    "Le marché mondial finira par sanctionner sans pitié les sociétés arrogantes gaspillant leurs immenses capitaux dans la poursuite obstinée de fantasmes technologiques inaccessibles et extrêmement ruineux d'aujourd'hui.", # 56: 28 words
    "Les fondements inébranlables de l'économie classique exigent systématiquement des rendements réels et palpables, une exigence que cette nouvelle vague spéculative virtuelle est totalement incapable de satisfaire à long terme.", # 57: 30 words
