...
import sys
with open('fix_counts_v3.py', 'r') as f:
    content = f.read()

content = content.replace('"Nous assistons à l\'éclatement progressif d\'une vaste bulle spéculative, où l\'enthousiasme aveugle des investisseurs fortunés se heurte brutalement aux limites technologiques du monde financier moderne.", # 12: 28 words.', '"Nous assistons à l\'éclatement progressif d\'une vaste bulle spéculative, où l\'enthousiasme aveugle des investisseurs fortunés se heurte brutalement aux limites technologiques du monde financier moderne.", # 12')
# Oh I see, I forgot to change sentence 12 and 51 in v3 array!
...
sentences = [
    ...
    "Nous assistons à l'éclatement progressif d'une vaste bulle spéculative, où l'enthousiasme aveugle des investisseurs fortunés se heurte brutalement aux limites technologiques du monde financier d'aujourd'hui.", # 12: 29 words
    ...
    "L'effondrement colossal de la confiance envers l'automatisation précipitera inévitablement une panique financière mondiale dévastatrice, détruisant définitivement les espoirs d'une croissance boursière infinie et miraculeuse pour tous.", # 50: 27 words -> add one word
...
sentences[50] = "L'effondrement colossal de la confiance envers l'automatisation précipitera inévitablement une panique financière mondiale extrêmement dévastatrice, détruisant définitivement les espoirs d'une croissance boursière infinie et miraculeuse pour tous." # 50: 28 words
